...
def main(img_path=None, vid_path=None,vid_out = None):
    ...
    model =  torch.hub.load('E:\yolov5-master', 'custom', source ='local', path='best_card.pt',force_reload=True) ### The repo is stored locally
    ...
    if img_path != None:
       ...
       # cv2.namedWindow("img_only", cv2.WINDOW_NORMAL) ## creating a free windown to show the result
        ...
        while True:
            # frame = cv2.cvtColor(frame,cv2.COLOR_RGB2BGR)
            cv2.imwrite("img_only.jpg", frame)
...
#main(vid_path="E:/Photo/card1.mp4",vid_out="vid_1.mp4") ### for custom video
# main(vid_path=0,vid_out="webcam_facemask_result.mp4") #### for webcam
main(img_path="E:/train/37.jpg") ## for image
